...
<form class="form-horizontal" action="<?php echo site_url('peminjaman/verifikasi');?>" method="post">
    ...
    <div class="panel-body">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input type="text" id="nama" name="nama" class="form-control" value="<?php echo $username;?>" readonly="readonly">
                    </div>
                </div>
            </div>
    </div>
...
<div class="panel panel-success">
    ...
    <div class="panel-body">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input type="text" id="jumlahpinjaman" name="jumlahpinjaman" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input type="text" id="bunga" name="bunga" class="form-control" style="width:50px;">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input type="text" id="cicilan" name="cicilan" class="form-control" style="width:50px;">
                    </div>
                </div>
				
				<div class="form-group">
                    <label class="col-lg-4 control-label">Keterangan</label>
                    <div class="col-lg-7" style="width: 800px"><br>
                        <textarea type="text" class="form-control" columns="5" id="keterangan" name="keterangan" style="width:100px;"></textarea>
                    </div>
                </div>
    ...
    <div class="panel-footer">
        <button id="simpan" class="btn btn-primary"><i class="glyphicon glyphicon-hdd"></i> Proses</button>
    </div>
	</form>
</div>
