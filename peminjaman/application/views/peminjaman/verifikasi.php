    ...
    <div class="panel-body">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input type="text" id="no" name="no" class="form-control" value="<?php echo $no;?>" readonly="readonly">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input type="text" id="tglpinjam" name="tglpinjam" class="form-control" value="<?php echo $tanggalpinjam;?>" readonly="readonly">
                    </div>
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input type="text" id="nama" name="nama" class="form-control" value="<?php echo $nama;?>" readonly="readonly">
                    </div>
                </div>
            </div>
    </div>
...
<div class="panel panel-success">
    ...
    <div class="panel-body">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input type="text" id="jumlahpinjaman" name="jumlahpinjaman" class="form-control" value="<?php echo $jumlahpinjaman;?>" readonly="readonly">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input type="text" id="bunga" name="bunga" class="form-control" style="width:50px;" value="<?php echo $bunga;?>" readonly="readonly">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input type="text" id="cicilan" name="cicilan" class="form-control" style="width:50px;" value="<?php echo $cicilan;?>" readonly="readonly">
                    </div>
                </div>
            </div>
			...
			<div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input type="text" id="jumlahangsuran" name="jumlahangsuran" class="form-control" value="<?php echo $jumlahangsuran;?>" readonly="readonly">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input type="text" id="totalangsuran" name="totalangsuran" class="form-control" value="<?php echo $totalangsuran;?>" readonly="readonly">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input type="text" id="keterangan" name="keterangan" class="form-control" value="<?php echo $keterangan;?>" readonly="readonly">
                    </div>
                </div>
    ...
    <div class="panel-footer">
        ...
        <button id="simpan" class="btn btn-primary"><i class="glyphicon glyphicon-hdd"></i> Kirim</button>
    </div>
	</form>
</div>
